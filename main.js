...
function gotResult(error , results) {
    ...
    drawn_sketch=results[0].label;
     document.getElementById("user_sketch").innerHTML ="Label : "  + results[0].label;
